...
export const availableThemes: AppTheme[] = [
    ...
    { id: 'aurora', name: 'Aurora', palette: { mode: 'dark', primary: '#64FFDA', primaryDark: '#00BFA5', secondary: '#B388FF', backgroundDefault: '#121F2A', paperBackground: '#1E3448', sidebarBackground: '#1A2C3D', contrastText: '#FFFFFF', divider: 'rgba(100, 255, 218, 0.15)', textPrimary: '#ECEFF1', textSecondary: '#B0BEC5', action: { hover: 'rgba(100, 255, 218, 0.08)', selected: 'rgba(100, 255, 218, 0.16)' } } },
